            ...
            return when (T::class) {
                BarNode::class -> {
                    val months2023 = listOf(
                        BarNode("jan-2024", "Янв 2024", 120.0f),
                        BarNode("feb-2024", "Фев 2024", 90.0f),
                        BarNode("mar-2024", "Мар 2024", 150.0f),
                        BarNode("apr-2024", "Апр 2024", 170.0f),
                        BarNode("may-2024", "Май 2024", 200.0f),
                        BarNode("jun-2024", "Июнь 2024", 250.0f),
                        BarNode("jul-2024", "Июль 2024", 350.0f),
                        BarNode("aug-2024", "Авг 2024", 400.0f),
                        BarNode("sep-2024", "Сент 2024", 320.0f),
                        BarNode("oct-2024", "Окт 2024", 130.0f),
                        BarNode("nov-2024", "Нояб 2024", 230.0f),
                        BarNode("dec-2024", "Дек 2024", 150.0f),
                    )
                    ...
                    val years = listOf(
                        BarNode("2024", "2024", 360.0f, months2024),
                ...
                PointNode::class -> {
                    return buildHierarchyFromFlatData(
                        rawData = listOf(
                            ...
                            RawDataPoint("2024-01-01T00:00", 10f),
                            RawDataPoint("2024-01-01T01:00", 12f),
                            RawDataPoint("2024-01-01T02:00", 8f),
                            RawDataPoint("2024-01-01T03:00", 15f),
                            RawDataPoint("2024-01-01T04:00", 20f),
                            RawDataPoint("2024-01-01T05:00", 18f),
                            RawDataPoint("2024-01-01T06:00", 25f),
                            RawDataPoint("2024-01-01T07:00", 30f),
                            RawDataPoint("2024-01-01T08:00", 28f),
                            RawDataPoint("2024-01-01T09:00", 22f),
                            RawDataPoint("2024-01-01T10:00", 35f),
                            RawDataPoint("2024-01-01T11:00", 40f),

                            RawDataPoint("2024-01-02T00:00", 15f),
                            RawDataPoint("2024-01-02T01:00", 18f),
                            RawDataPoint("2024-01-02T02:00", 10f),
                            RawDataPoint("2024-01-02T03:00", 22f),
                            RawDataPoint("2024-01-02T04:00", 25f),
                            RawDataPoint("2024-01-02T05:00", 20f),
                            RawDataPoint("2024-01-02T06:00", 32f),
                            RawDataPoint("2024-01-02T07:00", 35f),
                            RawDataPoint("2024-01-02T08:00", 30f),
                            RawDataPoint("2024-01-02T09:00", 28f),
                            RawDataPoint("2024-01-02T10:00", 42f),
                            RawDataPoint("2024-01-02T11:00", 38f),

                            RawDataPoint("2024-01-03T00:00", 20f),
                            RawDataPoint("2024-01-03T01:00", 22f),
                            RawDataPoint("2024-01-03T02:00", 15f),
                            RawDataPoint("2024-01-03T03:00", 25f),
                            RawDataPoint("2024-01-03T04:00", 30f),
                            RawDataPoint("2024-01-03T05:00", 25f),
                            RawDataPoint("2024-01-03T06:00", 38f),
                            RawDataPoint("2024-01-03T07:00", 40f),
                            RawDataPoint("2024-01-03T08:00", 35f),
                            RawDataPoint("2024-01-03T09:00", 32f),
                            RawDataPoint("2024-01-03T10:00", 45f),
                            RawDataPoint("2024-01-03T11:00", 42f),

                            RawDataPoint("2024-01-04T00:00", 25f),
                            RawDataPoint("2024-01-04T01:00", 28f),
                            RawDataPoint("2024-01-04T02:00", 18f),
                            RawDataPoint("2024-01-04T03:00", 30f),
                            RawDataPoint("2024-01-04T04:00", 35f),
                            RawDataPoint("2024-01-04T05:00", 30f),
                            RawDataPoint("2024-01-04T06:00", 42f),
                            RawDataPoint("2024-01-04T07:00", 45f),
                            RawDataPoint("2024-01-04T08:00", 40f),
                            RawDataPoint("2024-01-04T09:00", 38f),
                            RawDataPoint("2024-01-04T10:00", 48f),
                            RawDataPoint("2024-01-04T11:00", 45f),

                            RawDataPoint("2024-01-05T00:00", 30f),
                            RawDataPoint("2024-01-05T01:00", 32f),
                            RawDataPoint("2024-01-05T02:00", 25f),
                            RawDataPoint("2024-01-05T03:00", 35f),
                            RawDataPoint("2024-01-05T04:00", 40f),
                            RawDataPoint("2024-01-05T05:00", 35f),
                            RawDataPoint("2024-01-05T06:00", 45f),
                            RawDataPoint("2024-01-05T07:00", 50f),
                            RawDataPoint("2024-01-05T08:00", 45f),
                            RawDataPoint("2024-01-05T09:00", 42f),
                            RawDataPoint("2024-01-05T10:00", 50f),
                            RawDataPoint("2024-01-05T11:00", 45f)
                        ),
